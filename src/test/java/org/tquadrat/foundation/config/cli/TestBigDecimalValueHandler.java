 ...
 *  @version $Id: TestBigDecimalValueHandler.java 895 2021-04-05 12:40:34Z tquadrat $
 */
@ClassVersion( sourceVersion = "$Id: TestBigDecimalValueHandler.java 895 2021-04-05 12:40:34Z tquadrat $" )
@DisplayName( "org.tquadrat.foundation.config.cli.TestBigDecimalValueHandler" )
public class TestBigDecimalValueHandler extends ValueHandlerTestBase<BigDecimal>
{
        /*---------*\
    ====** Methods **==========================================================
        \*---------*/
     ...
     */
    @Override
    protected final CmdLineValueHandler<BigDecimal> createCandidate()
    {
        final var retValue = new SimpleCmdLineValueHandler<>( this::valueSetter, BigDecimalStringConverter.INSTANCE );
...
//  class TestBigDecimalValueHandler
