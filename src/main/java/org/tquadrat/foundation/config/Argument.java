 ...
 *  @thanks Mark Sinke
 *  @version $Id: Argument.java 907 2021-05-05 23:09:17Z tquadrat $
 *  @since 0.0.1
 *
 *  @UMLGraph.link
 */
@ClassVersion( sourceVersion = "$Id: Argument.java 907 2021-05-05 23:09:17Z tquadrat $" )
@Documented
@Retention( CLASS )
@Target( METHOD )
...
public @interface Argument
{
    ...
    /**
     *  A flag that indicates whether the argument is multi-valued, for
     *  mappings to a
     ...
     *
     *  @return {@code true} if the argument is multi-valued,
