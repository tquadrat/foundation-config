...
- Gradle
    ...
    dependencies {
      ...
      implementation 'org.tquadrat.library:org.tquadrat.foundation.config:0.25.12'
      annotationProcessor 'org.tquadrat.tool:org.tquadrat.foundation.config.ap:0.25.12'
      …
    }  //  dependencies
    ```
